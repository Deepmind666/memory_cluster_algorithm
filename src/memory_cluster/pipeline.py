...
def build_cluster_result(
    ...
    clusterer = IncrementalClusterer(
        ...
        enable_merge_upper_bound_prune=pref.enable_merge_upper_bound_prune,
        merge_prune_dims=pref.merge_prune_dims,
        ...
        merge_candidate_projection_steps=pref.merge_candidate_projection_steps,
        merge_candidate_signature_radius=pref.merge_candidate_signature_radius,
        ...
        merge_ann_projection_steps=pref.merge_ann_projection_steps,
    )
