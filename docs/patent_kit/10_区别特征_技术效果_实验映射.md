...
- 生成时间: 2026-02-11T01:22:01.189440+00:00
- 数据集快照时间: 2026-02-10T17:09:08.912401+00:00
- 证据条目数: 7
...
| DF-04 | 合并上界剪枝 Prune | 权利要求17 | primary_avg_speedup_ratio=-0.137349; primary_optimized_pairs_pruned=0 | implemented_and_measured |
| DF-05 | 签名桶候选筛选 Candidate Filter | 权利要求18 | sparse_attempt_reduction_ratio=0.75014; sparse_avg_speedup_ratio=0.426363 | implemented_and_measured |
| DF-06 | ANN 多表近似候选与混合门控 | 权利要求19 | sparse_ann_avg_speedup_ratio=0.113727; sparse_ann_quality_gate_pass=True | implemented_measured_not_default |
...
- 指标证据:
  - primary_avg_speedup_ratio: -0.137349
  - primary_optimized_pairs_pruned: 0
  - sparse_avg_speedup_ratio: 0.137943
  - sparse_optimized_pairs_pruned: 2519
  - realistic_avg_speedup_ratio: 0.07331
...
- 技术问题: 大规模候选对数量过大
- 技术手段: 按签名桶和邻桶限制候选邻接图
- 技术效果: 明显减少 merge attempts 且保持结果一致
- 指标证据:
  - sparse_attempt_reduction_ratio: 0.75014
  - sparse_avg_speedup_ratio: 0.426363
  - active_attempt_reduction_ratio: 0.444496
  - active_avg_speedup_ratio: 0.198265
...
- 指标证据:
  - sparse_ann_avg_speedup_ratio: 0.113727
  - sparse_ann_quality_gate_pass: True
  - active_ann_avg_speedup_ratio: -0.160874
  - active_ann_quality_gate_pass: True
  - active_hybrid_avg_speedup_ratio: -0.179044
